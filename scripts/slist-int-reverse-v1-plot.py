...
if not os.path.exists("slist-int-reverse-v1-eval.txt"):
    print("slist-int-reverse-v1-eval.txt does not exist!")
    exit(1)
...
ax.grid()
fig.savefig("slist-int-reverse-v1-plot.pdf", bbox_inches="tight")
